...
import { Theme, Text, Image, Strong, Box, Span } from "@quarkly/widgets";
		...
		<Section padding="50px 0 50px 0" background="#FA8669" lg-padding="0px 0 0px 0">
			...
			<Stack margin="0px 0px 0px 0px" gap="0px" border-radius="8px">
				...
				<StackItem width="50%" display="flex" md-width="100%" lg-width="100%">
					...
					<Image
						width="100%"
						src="https://uploads.quarkly.io/5f7f021a3d84d4001ec38356/images/1.jpg?v=2020-10-08T12:42:23.346Z"
						height="600px"
						object-fit="cover"
						border-radius="8px 0px 0px 8px"
					/>
